...
//                  System.out.println(result);
                  ...
                  String sql29 = String.format("select DISTINCT reserv.transreservdate as 결제일, train.traintype as 기차종류, a.trainstationname as 출발역, to_char(train.trainstart_time,'hh24:mi') as 출발시간," + 
                  ...
                  System.out.println("========================================================[기차 예매확인]=============================================================");
                  System.out.println("================================================================================================================================");
                  System.out.println("[결제일]\t[기차종류]\t[출발역]\t[출발시간]\t[도착역]\t[도착시간]\t[가격]");
                  while (rs.next()) { //역번호, 역이름  도착기준
                     
                     String result2 = String.format("%s\t%s\t%s\t%s\t%s\t%s\t%s",rs.getString("결제일"),rs.getString("기차종류"),rs.getString("출발역"),rs.getString("출발시간"),rs.getString("도착역"),rs.getString("도착시간"),rs.getString("가격"));            
...
//                System.out.println(result);
                ...
                String sql29 = String.format("select DISTINCT  reserv.transreservdate as 결제일,b.busstationloca as 출발지, to_char(bus.busstarttime,'hh24:mi') as 출발시간,a.busstationloca as 도착지,   bus.bustime as 소요시간,bus.busprice * reserv.transreservcount as 가격" + 
                      "    from tbltransreserv reserv" + 
                ...
                System.out.println("========================================================[버스 예매확인]=============================================================");
                System.out.println("================================================================================================================================");
                System.out.println("[결제일]\t[출발지]\t[출발시간]\t[도착지]\t[소요시간]\t[가격]");
                while (rs.next()) { //역번호, 역이름  도착기준
                   
                   String result2 = String.format("%s\t%s\t%s\t%s\t%s\t%s",rs.getString("결제일"),rs.getString("출발지"),rs.getString("출발시간"),rs.getString("도착지"),rs.getString("소요시간"),rs.getString("가격"));            
